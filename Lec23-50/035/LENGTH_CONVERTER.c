...
// double millimeter_to_foot(double);
// double millimeter_to_yard(double);
// double millimeter_to_milr(double);
...
// double centimeter_to_mmillimeter(double);
// double meter_to_millimeter(double);
// double kilometer_to_millimeter(double);
// double inch_to_millimeter(double);
// double foot_to_millimeter(double);
// double yard_to_millimeter(double);
// double mile_to_mmillimeter(double);
...
void do_conversion(int from_choice, int to_choice, double imput_number);
...
// int get_choice(const char *prompt, int valid_response_start, int valid_response_end);
// int get_choice(const char *prompt, int valid_response_start, int valid_response_end);
// int get_choice(const char *prompt, int vliad_response_start, int valid_response_end);
...
//             exit_application();
//         }
//         do_conversion(from_choice, to_choice, input_nuumber);
//     }
